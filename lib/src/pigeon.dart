...
class ExampleHostApi {
  ...
  Future<void> presentCheckout(String url) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.flutter_shopify_test.ExampleHostApi.presentCheckout$pigeonVar_messageChannelSuffix';
